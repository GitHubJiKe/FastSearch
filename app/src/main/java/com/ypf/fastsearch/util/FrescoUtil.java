...
public class FrescoUtil {
    ...
    public static void init(Context context, String... args) {
        if (args != null) {
            ...
            if (!TextUtils.isEmpty(path)) {
                Fresco.initialize(context, getImagePipelineConfig(context, path));
            }
        } else {
     ...
     */
    private static ImagePipelineConfig getImagePipelineConfig(Context context, String diskCachePath) {
     ...
     */
    public static void displayPicFromNet(SimpleDraweeView simpleDraweeView, String url, ImageRequest.ImageType imageType, boolean isgif) {
     ...
     */
    public static void displayPicFromNetWithListener(SimpleDraweeView simpleDraweeView, String url, ImageRequest.ImageType imageType, ControllerListener<? super ImageInfo> listener, boolean isgif) {
        if (url.compareTo(checkTag(simpleDraweeView, url)) != 0) {
            simpleDraweeView.setTag(url);//设置tag为了避免重复加载相同url的图片
     ...
     * @return 新的URL
     */
    private static String checkTag(SimpleDraweeView simpleDraweeView, String url) {
     ...
     * @param imageType        显示类型
     */
    public static void displayPicFromLocal(SimpleDraweeView simpleDraweeView, String url, ImageRequest.ImageType imageType, boolean isgif) {
        DraweeController draweeController = Fresco.newDraweeControllerBuilder()
     ...
     * @param id               资源ＩＤ
     */
    public static void displayPicFromResource(SimpleDraweeView simpleDraweeView, String pacakgeName, int id, boolean isgif) {
        DraweeController draweeController = Fresco.newDraweeControllerBuilder()
     ...
     * @param imageType        显示类型
     */
    public static void displayPicFromNetOrLocal(SimpleDraweeView simpleDraweeView, String localUri, String networkUri, ImageRequest.ImageType imageType, boolean isgif) {
     ...
     */
    private static ImageRequest getImageRequest(String url, ImageRequest.ImageType imageType) {
